...
requirejs([
        ...
        requirejs(['text!view/Grid.html'], function() {
            var p = new DOMParser();
            var viewslength = arguments.length;
            var vX;
            var n;
            for(vX = 0; vX < viewslength; vX++) {
            	n = p.parseFromString(arguments[vX], 'text/html');
